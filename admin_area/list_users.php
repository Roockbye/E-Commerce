<h3 class="text-center text-success text-black">All Users</h3>
<table class="table table-bordered mt-5">
    ...
    <tbody class="bg-secondary text-light">
        ...
        <tr class="text-center">
            ...
            <td><img src='../users_area/user_images/<?php echo $user_image;?>' alt='<?php echo $username;?>' class='product_img'/></td>
