...
if (isset($_POST['user_update'])) {
    ...
    if ($result_query_update) {
        echo "<script>alert('Mise à jour des données effectuée avec succès')</script>";
        echo "<script>window.open('profile.php','_self')</script>";
    }  else {
        echo "<script>alert('Erreur lors de la mise à jour des données')</script>";
    }
}
?>
...
<form action="" method="POST" enctype="multipart/form-data">
    ...
    <input type="submit" value="Mettre à jour" class="btn btn-secondary py-2 px-3 border-0" name="user_update">
</form>
